...
export default function Slider({ children, h2, breakPoints, margin }) {
  const prevRef = useRef(null);
  const nextRef = useRef(null);
  return (
    <div className={`my-${margin || "20"} p-3 relative`}>
      <h2 className="mb-4 font-semibold text-2xl lg:text-3xl text-gray-400">
        {h2}
      </h2>
      <Swiper
        breakpoints={{
